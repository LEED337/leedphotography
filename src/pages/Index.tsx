        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Users, title: "Family Portraits in Northern Utah", desc: "Beautiful family photos and professional headshots at stunning locations across Salt Lake City, Sandy, Draper, American Fork, Provo, Orem, and anywhere in Utah." },
